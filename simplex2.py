...
def calc_hill_2red(hills, Fmin, a, k):
    return [
        round(k * Fmin[0] - (hills[0][0] + hills[1][0]) / (a * 2), 4),
        round(k * Fmin[1] - (hills[0][1] + hills[1][1]) / (a * 2), 4),
        round(input_F(round(k * Fmin[0] - (hills[0][0] + hills[1][0]) / (a * 2), 4),
                      round(k * Fmin[1] - (hills[0][1] + hills[1][1]) / (a * 2), 4), ), 4)
    ]
    ...
    while c < 30:
        ...
        for i in hills:
            if i == Fmin:
                ...
                #hills.remove(i)
                #hills.append(Fmin)
                hill_min_red = calc_hill_2red(hills, hills[2], a, k)
